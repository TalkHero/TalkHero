...
trackEvent("speaking_completed", {
  ...
  return (
    <section className="flex h-full min-h-0 w-full min-w-0 max-w-full flex-1 flex-col overflow-clip rounded-3xl border border-slate-200 bg-white shadow-sm">
      <div className="flex shrink-0 items-center justify-between gap-2 border-b border-slate-200 px-3 py-2.5 sm:px-4 lg:gap-4 lg:px-6 lg:py-5">
        <div className="flex min-w-0 items-center gap-2">
          <div
            className={`flex h-9 w-9 shrink-0 items-center justify-center rounded-xl lg:h-11 lg:w-11 lg:rounded-2xl ${
              sessionActive
        ...
        {sessionActive ? (
          <button
            type="button"
            onClick={stopSession}
            className="flex shrink-0 items-center gap-1.5 rounded-lg bg-red-50 px-3 py-2 text-xs font-semibold text-red-600 transition hover:bg-red-100 lg:gap-2 lg:rounded-xl lg:px-4 lg:py-2.5 lg:text-sm"
          >
            <PhoneOff className="h-4 w-4" />
            <span className="lg:hidden">Завершити</span>
            <span className="hidden lg:inline">Завершити сесію</span>
          </button>
        ) : (
          <button
            type="button"
            ...
            className="flex shrink-0 items-center gap-1.5 rounded-lg bg-indigo-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-indigo-700 disabled:cursor-not-allowed disabled:opacity-50 lg:gap-2 lg:rounded-xl lg:px-5 lg:py-2.5 lg:text-sm"
          >
            {startingSession ? (
      ...
      <div className="grid min-h-0 w-full min-w-0 max-w-full flex-1 grid-cols-[minmax(0,1fr)] lg:grid-cols-[340px_minmax(0,1fr)]">
        ...
        <div className="flex min-h-0 w-full min-w-0 max-w-full flex-col">
          <div className="w-full min-w-0 max-w-full shrink-0 overflow-hidden border-b border-slate-200 bg-white/95 px-3 py-2 shadow-sm backdrop-blur lg:hidden">
            <div className="flex min-w-0 items-center gap-2">
              <div className="relative shrink-0">
                ...
                <div
                  className={`relative h-12 w-12 overflow-hidden rounded-full border-2 bg-white shadow-sm ${
                    phase === "listening"
                      ? "border-indigo-500"
                      : phase === "thinking"
                        ? "border-amber-400"
              ...
              <div className="min-w-0 flex-1 overflow-hidden">
                <div className="flex min-w-0 items-center gap-2">
                  ...
                  <div
                    className={`inline-flex min-w-0 items-center gap-1 rounded-full px-2.5 py-1 text-xs font-semibold ${
                      phase === "listening"
                ...
                <p className="mt-0.5 truncate text-xs text-slate-500">
                  Твоя AI-репетиторка · {phaseInformation.description}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="min-h-0 flex-1 overflow-y-auto p-3 sm:p-5 lg:p-7">
            {messages.length === 0 ? (
              ...
              <div className="mx-auto max-w-2xl space-y-3 sm:space-y-4 lg:space-y-5">
